...
const AudioPage = () => {
    ...
    useEffect(() => {
        ...
        const ambientLight = new THREE.AmbientLight(0xffffff, 1.2) // Aumentei um pouco a luz ambiente
    ...
    return (
        <main className="p-8 flex-grow bg-gray-100 min-h-screen">
            <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
                <div className="w-full lg:w-7/12 bg-white p-6 rounded-2xl shadow-lg h-fit">
                    ...
                    <textarea
                        className="w-full h-48 p-4 border border-gray-200 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#69ACD5] transition-all"
